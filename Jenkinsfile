    ...
    stages {
        ...
        stage('Build Images') {
            steps {
                script {
                    // Nome das imagens
                    def imageNameWeb = 'arimateiajunior/web'
                    def imageNameDB = 'arimateiajunior/db'
                    def imageNameNginx = 'arimateiajunior/nginx'

                    // Executa o build das imagens com os respectivos Dockerfiles
                    docker.withRegistry('https://registry.hub.docker.com', 'dockerhubarimateiajunior') {
